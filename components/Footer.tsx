          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-8">
              <div className="relative">
                <img src="/images/logo.png" alt="Jyotish Lok" className="w-16 h-16 mr-4 drop-shadow-lg" />
            ...
            <div className="flex space-x-4">
              <a href="#" className="group w-12 h-12 bg-gray-800 hover:bg-[#F37D00] rounded-full flex items-center justify-center transition-all duration-300 border border-gray-700 hover:border-[#F37D00]">
                <span className="text-gray-300 group-hover:text-white font-bold text-lg">f</span>
              </a>
              <a href="#" className="group w-12 h-12 bg-gray-800 hover:bg-[#0EB5A2] rounded-full flex items-center justify-center transition-all duration-300 border border-gray-700 hover:border-[#0EB5A2]">
                <span className="text-gray-300 group-hover:text-white font-bold text-sm">in</span>
              </a>
              <a href="#" className="group w-12 h-12 bg-gray-800 hover:bg-[#EA3F37] rounded-full flex items-center justify-center transition-all duration-300 border border-gray-700 hover:border-[#EA3F37]">
                <span className="text-gray-300 group-hover:text-white font-bold text-lg">t</span>
              </a>
              <a href="#" className="group w-12 h-12 bg-gray-800 hover:bg-[#EFFD07] rounded-full flex items-center justify-center transition-all duration-300 border border-gray-700 hover:border-[#EFFD07]">
                <span className="text-gray-300 group-hover:text-white font-bold text-sm">yt</span>
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              ...
              <a href="/terms-of-use" className="text-orange-500 hover:text-white transition-colors ml-2">{t('footer.terms')}</a> | 
              <a href="/privacy-policy" className="text-orange-500 hover:text-white transition-colors ml-2">{t('footer.privacy')}</a>
            </p>
            <LanguageSwitcher />
          </div>
        </div>

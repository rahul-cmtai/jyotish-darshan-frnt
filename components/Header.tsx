...
import { Menu, X, Facebook, Linkedin, Twitter, Youtube, ChevronDown } from "lucide-react"
...
export default function Header() {
  ...
  const serviceLinks = [
    ...
    { name: "यंत्र", href: "/services/yantra", englishName: "Yantra" },
    { name: "किताबें", href: "/services/books", englishName: "Books" },
    { name: "साधना", href: "/services/sadhana", englishName: "Sadhana" },
    { name: "पूजाएं", href: "/services/pujas", englishName: "Pujas" },
  ]
    ...
    <header className="bg-white shadow-sm">
      ...
      <div className="bg-gray-50 py-2 px-4 text-xs sm:text-sm text-gray-600">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0">
          <span className="text-center sm:text-left">{t('website.talkToAstrologers')} : +91 9773380099</span>
      ...
      <nav className="px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* Panshang */}
            <button
              onClick={() => handleNavigation("/panshang")}
              className="font-medium transition-colors text-gray-700 hover:text-orange-500"
            >
              {t('website.panshang')}
            </button>
            ...
            <div className="flex flex-col space-y-3 pt-4 px-2">
              ...
              <div className="border-t pt-3 mt-3">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform ${isKundliOpen ? 'rotate-180' : ''}`} />
                </button>
                {isKundliOpen && (
                  <div className="mt-2 ml-4 space-y-2">
                    <button
